...
$bar_image = $prli_options->Smartbar_image_url;
$bar_background_image = $prli_options->Smartbar_background_image_url;
$bar_color = $prli_options->Smartbar_color;
$bar_text_color = $prli_options->Smartbar_text_color;
$bar_link_color = $prli_options->Smartbar_link_color;
$bar_visited_color = $prli_options->Smartbar_visited_color;
$bar_hover_color = $prli_options->Smartbar_hover_color;
$bar_show_title = $prli_options->Smartbar_show_title;
$bar_show_description = $prli_options->Smartbar_show_description;
$bar_show_share_links = $prli_options->Smartbar_show_share_links;
$bar_show_target_url_link = $prli_options->Smartbar_show_target_url_link;
$bar_title_limit = (int)$prli_options->Smartbar_title_limit;
$bar_desc_limit = (int)$prli_options->Smartbar_desc_limit;
$bar_link_limit = (int)$prli_options->Smartbar_link_limit;
        ...
        <div class="pb-cell right_container">
          <table width="100%" cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px;">
            ...
            <tr>
              ...
              <?php
                $link_html =<<<LINKHTML
<p class="powered-by small-text">Powered by <a href="http://blairwilliams.com/pl" target="_top"><img src="images/Smart-link-small.png" width="12px" height="12px" border="0"/> Smart Link</a></p>
LINKHTML;
