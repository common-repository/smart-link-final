...
/** Okay, this class is not a pure model -- it contains all the functions
  * necessary to successfully provide an update mechanism for SmartLinkPro!
  */
class PrliUpdate
{
  var $plugin_name;
  ...
  function PrliUpdate()
  {
    ...
    $this->plugin_name            = 'Smart-link/Smart-link.php';
    $this->plugin_slug            = 'Smart-link';
    $this->plugin_url             = 'http://blairwilliams.com/pl';
    $this->pro_script             = PRLI_PATH . '/pro/Smart-link-pro.php';
    $this->pro_mothership         = 'http://Smartlinkpro.com';
    ...
    $this->pro_username_label     = __('Smart Link Pro Username');
    $this->pro_password_label     = __('Smart Link Pro Password');
    $this->pro_error_message_str  = __('Your Smart Link Pro Username or Password was Invalid');
...
<div class="error">
  <ul>
    <li><strong><?php _e('ERROR', 'Smart-link'); ?></strong>: <?php echo $this->pro_error_message_str; ?></li>
  </ul>
</div>
        <?php
      }
