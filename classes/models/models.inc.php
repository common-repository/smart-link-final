...
function prli_get_main_message( $message = "Get started by <a href=\"?page=Smart-link/prli-links.php&action=new\">adding a URL</a> that you want to turn into a Smart Link.<br/>Come back to see how many times it was clicked.", $expiration=3600) // Get new messages every 1 hour
{
  global $prli_update, $wp_version;
  include_once(ABSPATH."/wp-includes/class-IXR.php");

  $message_mothership = (($prli_update->pro_is_installed_and_authorized())?'http://Smartlinkpro.com/xmlrpc.php':'http://blairwilliams.com/xmlrpc.php');
