...
<h2><img src="<?php echo PRLI_URL.'/images/Smart-link-med.png'; ?>"/>&nbsp;Smart Link: CSV Downloads</h2>
...
<span class="description">Shows all of the Smart Links that visitors in <?php echo stripslashes($link_name); ?> have visited identified by IP address and sorted in descending order by date.</span> 
<br/>
<ul>
<?php
...
<span class="description">Shows the first the Smart Link that visitors in <?php echo stripslashes($link_name); ?> have visited identified by IP address and the hit(s) that got these visitors listed in <?php echo stripslashes($link_name); ?>.</span> 
<br/>
<ul>
<?php
