...
?>
  <h2><img src="<?php echo PRLI_URL.'/images/Smart-link-med.png'; ?>"/>&nbsp;Smart Link: Hits</h2>
<h1 style="text-align: left">For Instructions Visit:<a href="http://111waystomakemoney.com/smart-link/" target="_blank">Plugin Page</a></h1>
  <span style="font-size: 15px; font-weight: bold;">For <?php echo stripslashes($link_name); ?>: </span>
  <?php
...
<table class="widefat post fixed" cellspacing="0">
  ...
  else
  {
    foreach($clicks as $click)
    {
      ?>
      <tr>
        <td><img src="http://d15715w921jdje.cloudfront.net/browser/<?php echo prli_browser_image($click->btype); ?>" alt="<?php echo $click->btype . " v" . $click->bversion; ?>" title="<?php echo $click->btype . " v" . $click->bversion; ?>"/>&nbsp;<img src="http://d15715w921jdje.cloudfront.net/os/<?php echo prli_os_image($click->os); ?>" alt="<?php echo $click->os; ?>" title="<?php echo $click->os; ?>"/></td>
...
<a href="?page=Smart-link/prli-clicks.php&action=csv<?php echo $page_params; ?>">Download CSV (<?php echo stripslashes($link_name); ?>)</a>
