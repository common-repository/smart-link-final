<table class="form-table">
  ...
  <tr>
    <td valign="top">Smart Link*: </td>
    <td><strong><?php echo $prli_blogurl; ?></strong>/<input type="text" name="slug" value="<?php echo $values['slug']; ?>" size="50"/>
    <a class="toggle">&nbsp;[?]</a>
    <span class="toggle_pane description"><br/>Enter the slug (word trailing your main URL) that will form your Smart Link and redirect to the URL above.</span></td>
  </tr>
  <tr class="form-field">
    <td width="75px" valign="top">Title: </td>
    <td><input type="text" name="name" value="<?php echo $values['name']; ?>" />
    <a class="toggle">&nbsp;[?]</a>
      <span class="description toggle_pane"><br/>This will act as the title of your Smart Link. If a name is not entered here then the slug name will be used.</span></td>
  </tr>
  <tr class="form-field">
  ...
  <tr>
    <td valign="top" width="50%">
      ...
      <div class="pane">
        ...
        <div class="toggle_pane description"><strong>307 Redirection</strong> is the best option if your Target URL could possibly change or need accurate reporting for this link.<br/><br/><strong>301 Redirection</strong> is the best option if you're <strong>NOT</strong> planning on changing your Target URL. Traditionally this option is considered to be the best approach to use for your SEO/SEM efforts but since Smart Link uses your domain name either way this notion isn't necessarily true for Smart Links. Also, this option may not give you accurate reporting since proxy and caching servers may go directly to your Target URL once it's cached.<br/><br/><strong>Smart Bar Redirection</strong> is the best option if you want to show the Smart Bar at the top of the page when redirecting to the Target URL.<br/><br/><strong>Cloak Redirection</strong> is the best option if you don't want your Target URL to be visible even after the redirection. This way, if a Target URL doesn't redirect to a URL you want to show then this will mask it.<br/><br/><strong>Pixel Redirection</strong> is the option you should select if you want this link to behave like a tracking pixel instead of as a link. This option is useful if you want to track the number of times a page or email is opened. If you place your Smart Link inside an img tag on the page (Example: <code>&lt;img src="<?php echo $prli_blogurl . "/yourslug"; ?>" /&gt;</code>) then the page load will be tracked as a click and then displayed. Note: If this option is selected your Target URL will simply be ignored if there's a value in it.</div>
        <?php global $prli_update; ?>
        <?php if(!$prli_update->pro_is_installed_and_authorized()) { ?>
              <p class="description">To Enable Cloaking &amp; Smart Bar<br/>Upgrade to <a href="http://Smartlinkpro.com">Smart Link Pro</a></p>
        <?php } ?>
      </div>
      <br/>
      <h3>SEO Options</h3>
    ...
    <td valign="top" width="50%">
      ...
      <ul style="list-style-type: none" class="pane">
        ...
        <li>
          ...
          <div class="toggle_pane description">Select this option if you want to forward parameters through your Smart Link to your Target URL. This will allow you to pass parameters in the standard syntax for example the Smart Link <code>http://yoururl.com/coollink?product_id=4&sku=5441</code> will forward to the target URL and append the same parameters like so: <code>http://anotherurl.com?product_id=4&sku=5441</code>.</div>
        </li>
        <!--
        <li>
          ...
          <div class="toggle_pane description">Select this option if you want to forward parameters through your Smart Link to your Target URL and write the parameters in a custom format. For example, say I wanted to to have my links look like this: <code>http://yourdomain.com/products/15/4</code> and I wanted this to forward to <code>http://anotherurl.com?product_id=15&dock=4</code> you'd just select this option and enter the following string into the text field <code>/products/%product_id%/%dock%</code>. This will tell Smart Link where each variable will be located in the URL and what each variable name is.</div>
        </li>
        -->
      </ul>
    </td>
