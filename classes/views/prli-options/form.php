...
<h2 id="prli_title">Smart Link: Options</h2>
<br/>
...
<a href="admin.php?page=<?php echo PRLI_PLUGIN_NAME; ?>/prli-links.php">&laquo Smart Link Admin</a>
...
<br/><span class="description">Add the <code>nofollow</code> attribute by default to new links.</span>
  ...
  <li>
    <input type="checkbox" name="<?php echo $link_prefix; ?>" <?php echo (($prli_options->link_prefix != 0)?'checked="true"':''); ?>/>&nbsp; Use a prefix from your Permalink structure in your Smart Links
...
<table class="reporting-toggle-pane form-table">
  ...
  <tr>
    <td colspan="2">
      ...
      <br/><span class="description"><?php _e('Filter known Robots and unidentifiable browser clients from your hit data, stats and reports. <code>IMPORTANT: Any robot hits recorded with any version of Smart Link before 1.4.22 won\'t be filtered by this setting.</code>'); ?></span>
