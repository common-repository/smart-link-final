<?php
define('PRLI_PLUGIN_NAME',"Smart-link-final");
...
function setup_new_vars($groups)
{
  ...
  $values['redirect_type']['Smartbar'] = (((isset($_POST['redirect_type']) and $_POST['redirect_type'] == 'Smartbar') or (!isset($_POST['redirect_type']) and $prli_options->link_redirect_type == 'Smartbar'))?'selected="selected"':'');
...
function setup_edit_vars($groups,$record)
{
  ...
  $values['redirect_type']['Smartbar'] = (((isset($_POST['redirect_type']) and $_POST['redirect_type'] == 'Smartbar') or (isset($record->redirect_type) and $record->redirect_type == 'Smartbar'))?' selected="selected"':'');
