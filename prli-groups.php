...
{
  $prli_message = "Create a group and use it to organize your Smart Links.";
...
else if($params['action'] == 'create')
{
  ...
  else
  {
    ...
    $prli_message = "Your Smart Link Group was Successfully Created";
...
else if($params['action'] == 'update')
{
  ...
  else
  {
    ...
    $prli_message = "Your Smart Link Group was Successfully Updated";
    prli_display_groups_list($params, $prli_message, '', 1);
  }
}
else if($params['action'] == 'destroy')
{
  ...
  $prli_message = "Your Smart Link Group was Successfully Deleted";
  prli_display_groups_list($params, $prli_message, '', 1);
}
