...
if($params['action'] == 'list')
{
  ...
  if($params['regenerate'] == 'true')
  {
    ...
    $prli_message = "Your Smart Links were Successfully Regenerated";
  }
...
else if($params['action'] == 'quick-create')
{
  ...
  else
  {
    ...
    $prli_message = "Your Smart Link was Successfully Created";
...
else if($params['action'] == 'bulk-update')
{
  ...
  {
    $prli_message = "Your Smart Links were Successfully Updated";
    prli_display_links_list($params, $prli_message, '', 1);
  }
}
else if($params['action'] == 'update')
{
  ...
  else
  {
    ...
    $prli_message = "Your Smart Link was Successfully Updated";
    prli_display_links_list($params, $prli_message, '', 1);
  }
}
else if($params['action'] == 'reset')
{
  ...
  $prli_message = "Your Smart Link was Successfully Reset";
  prli_display_links_list($params, $prli_message, '', 1);
}
else if($params['action'] == 'destroy')
{
  $prli_link->destroy( $params['id'] );
  $prli_message = "Your Smart Link was Successfully Destroyed";
  prli_display_links_list($params, $prli_message, '', 1);
}
