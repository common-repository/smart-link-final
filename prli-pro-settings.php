...
if($_GET['action'] == 'force-pro-reinstall')
{
  ...
  $reinstall_url = wp_nonce_url('update.php?action=upgrade-plugin&plugin=Smart-link/Smart-link.php', 'upgrade-plugin_Smart-link/Smart-link.php');
?>
<div class="updated"><p><strong><?php printf(__('You\'re almost done!<br/>%1$sFinish your Re-Install of Smart Link Pro%2$s'), '<a href="'.$reinstall_url.'">', '</a>'); ?></strong></p></div>
<?php
}
if($_GET['action'] == 'pro-uninstall')
{
  ...
  <div class="updated"><p><strong><?php _e('Smart Link Pro Successfully Uninstalled.' ); ?></strong></p></div>
  <?php
}
